  ...
  <div class="h-screen flex items-center justify-center bg-terminal-black text-terminal-text font-sans p-6">
    <div class="max-w-md w-full space-y-8 bg-terminal-dark border border-terminal-gray p-8 rounded-xl shadow-2xl relative overflow-hidden group">
      ...
      <div class="text-center relative">
        ...
        <p class="text-terminal-text/60 text-sm">Secure access for authorized traders only.</p>
      </div>

      <div class="space-y-4 relative">
        <button 
          @click="login"
          class="w-full flex items-center justify-center gap-3 bg-white hover:bg-terminal-highlight text-terminal-black font-bold py-3.5 px-6 rounded-lg transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg"
        >
        ...
        <div class="flex items-center gap-2 justify-center text-[10px] uppercase tracking-widest text-terminal-text/30 font-bold">
          <Lock class="w-3 h-3" />
      ...
      <div class="pt-6 border-t border-terminal-gray/50 text-center relative">
        <p class="text-[11px] text-terminal-text/40 leading-relaxed">
          By signing in, you acknowledge that access is restricted to the whitelisted administrator email.
        </p>
      </div>
    </div>
  </div>
